...
namespace Make3D.API.Tools
{
    public class FileService : IFileService
    {
        ...
        #endregion
        #region Upload File
        public void UploadFile(List<IFormFile> files, string subDirectory, int articleId, IFichierService fichierService)
        {
            subDirectory = subDirectory ?? string.Empty;
            var target = Path.Combine(_hostingEnvironment.ContentRootPath, FileService.RootDirectory, subDirectory);
            ...
            files.ForEach(async file =>
            {
                ...
                using (var stream = new FileStream(filePath, FileMode.Create))
                {
                    ...
                    fichierService.Create(new FichierModel
                    {
                        Name = file.FileName,
